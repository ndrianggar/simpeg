						...
						<div class="row">
							<div class="x_panel">
								...
								<div class="x_content">
									<div class="form-horizontal col-md-6 col-sm-6 col-xs-12">
										...
										<div class="row">
											<div class="form-group">
												<label class="label-control col-md-4 col-sm-12 col-xs-12">Jenis Pegawai</label>
												<div class="col-md-8 col-sm-12 col-xs-12">
													<select id="id_jenis" name="nm_jenis" class="form-control selectpicker">
									...
									<a id="cetak" href="<?=base_url()?>pegawai/cetak_duk_jenis/Semua"><button id="btn-cetak-excel" class="btn btn-success">Cetak Excel</button></a>
								</div>
							</div>
						</div>
					</div>
	...
	<script>
		$(document).ready(function(){
			...
			var tabel = $('#tabel-data').DataTable({
				...
				"sAjaxSource": 	'<?php echo base_url(); ?>pegawai/data_duk_jenis/' + $('#id_jenis').val(),
				"aoColumns":	[
									{ "mData"	: "no"},
									{ "mData"	: "nama"},
									{ "mData"	: "nip_baru"},
			...
			$('#id_jenis').on('change',function(){
				$('#cetak').attr('href','<?=base_url()?>pegawai/cetak_duk_jenis/'+ $(this).val());
				var tabel = $('#tabel-data').DataTable({
					"bProcessing": 	true,
					"bAutoWidth": 	true,
					"bSort": 		true,
					"destroy": 		true,
					"lengthMenu": 	[ 25, 50, 75, 100 ],
					"sAjaxSource": 	'<?php echo base_url(); ?>pegawai/data_duk_jenis/' + $(this).val(),
					"aoColumns":	[
										{ "mData"	: "no"},
										{ "mData"	: "nama"},
										{ "mData"	: "nip_baru"},
