	...
	<script>
		$(document).ready(function(){
			...
			var tabel_keluarga = $('#data-keluarga').DataTable({
				...
				"columnDefs": 	[
									{ className: "text-center", "targets": [0,1,5,6,9] },
									{ width: 30, targets: 0},
									// { width: 50, targets:}
								],
				"fixedColumns": true
			...
			var tabel_organisasi = $('#data-organisasi').DataTable({
				...
				"columnDefs": 	[
									{ className: "text-center", "targets": [0,6,3] },
									{ width: 30, targets: 0},
									// { width: 50, targets: 7}
								],
				"fixedColumns": true
			...
			var tabel_suratlain = $('#data-suratlain').DataTable({
				...
				"columnDefs": 	[
									{ className: "text-center", "targets": [0,5,2] },
									{ width: 30, targets: 0},
									// { width: 50, targets: 6}
								],
				"fixedColumns": true
			...
			var tabel_pendidikan= $('#data-pendidikan').DataTable({
				...
				"columnDefs": 	[
									{ className: "text-center", "targets": [0,8,4] },
			...
			var tabel_kursus = $('#data-kursus').DataTable({
				...
				"columnDefs": 	[
									{ className: "text-center", "targets": [0,8,3] },
			...
			var tabel_pangkat = $('#data-pangkat').DataTable({
				...
				"columnDefs": 	[
									{ className: "text-center", "targets": [0,3,7,10] },
			...
			var tabel_penghargaan = $('#data-penghargaan').DataTable({
				...
				"columnDefs": 	[
									{ className: "text-center", "targets": [0,4,2] },
									{ width: 30, targets: 0},
									{ width: 50, targets: [4]}
								],
				"fixedColumns": true
			...
			var tabel_kunjungan = $('#data-kunjungan').DataTable({
				...
				"columnDefs": 	[
									{ className: "text-center", "targets": [0,5,3]},
									{ width: 30, targets: 0},
									{ width: 50, targets: [5]}
								],
				"fixedColumns": true
