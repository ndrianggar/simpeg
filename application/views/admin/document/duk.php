						...
						<div class="row">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										...
										<a href="<?=base_url()?>pegawai/duk">
											...
											<input type="text" id="jurusan" value="<?=$jurusan?>" />
										</a>
									</h2>
								...
								<div class="x_content">
									...
									<a href="<?=base_url()?>pegawai/cetak_duk/<?=$jurusan?>"><button id="btn-cetak-excel" class="btn btn-success">Cetak Excel</button></a>
								</div>
							</div>
						</div>
					</div>
	...
	<script>
		$(document).ready(function(){
			var tabel = $('#tabel-data').DataTable({
				...
				"sAjaxSource": 	'<?php echo base_url(); ?>pegawai/data_duk/' + $('#jurusan').val(),
				"aoColumns":	[
									{ "mData"	: "no"},
									{ "mData"	: "nama"},
									{ "mData"	: "nip_baru"},
