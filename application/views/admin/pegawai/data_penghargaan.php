						...
						<div class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12">
									...
									<!-- <input id="nama_h" class="form-control"> -->
									<span  id="nama_h" ></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12 has-feedback">
									...
									<span  id="tahun_h" ></span>
									<!-- <input id="tahun_h" class="form-control"> -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12">
									...
									<span  id="pemberi_h" ></span>
									<!-- <input id="pemberi_h" class="form-control"> -->
								</div>
							</div>
							<div class="form-group">
								<label class="label-control col-md-4 col-sm-12 col-xs-12">File (pdf)</label>
								<div class="col-md-8 col-sm-12 col-xs-12">
									<input class="form-control" type="file" name="file_penghargaan" id="file_penghargaan" accept="application/pdf">
									<a id="lihat_file_penghargaan" class="form-control" href="" target="_blank">Lihat File</a>
								</div>
							</div>
						</div>
					</div>
