					...
					<div class="modal-body scroll_modal">
						<div class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12">
									<input class="form-control" type="file" name="file_hukuman" id="file_hukuman" accept="application/pdf">
									<a id="lihat_file_hukuman" class="form-control" href="" target="_blank">Lihat File</a>
								</div>
							</div>
						</div>
					</div>
