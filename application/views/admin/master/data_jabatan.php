											...
											<div class="form-horizontal">
												<div class="form-group">
													...
													<div class="col-md-8 col-sm-8 col-xs-12">
														...
														<select id="tambah-jenis" name="tambah-jenis"  class="form-control selectpicker" data-live-search="true" required="required" title="-- Pilih Jenis Jabatan --">
															<?php
												...
												<div class="form-group">
													...
													<div class="col-md-8 col-sm-8 col-xs-12">
														<select id="tambah-eselon" name="tambah-eselon"  class="form-control selectpicker" data-live-search="true" title="-- Pilih Eselon --">
															<?php
												...
												<div class="form-group">
													...
													<div class="col-md-8 col-sm-8 col-xs-12">
														<select id="peraturan" name="peraturan"  class="form-control selectpicker" data-live-search="true" title="-- Pilih Peraturan --">
															<?php
	...
	<script>
		$(document).ready(function(){
			...
			$('#tabel-body').on('click', '#btn-ubah', function(){
				...
				$('#tambah-jenis').val($(this).data('jenis')).change();
				$('#tambah-nama').val($(this).data('nama'));
				$('#tambah-eselon').val($(this).data('eselon')).change();
				$('#tambah-kelas').val($(this).data('kelas'));
				$('#tunjangan').val($(this).data('tunjangan'));
				$('#peraturan').val($(this).data('peraturan')).change();
				$('#modal-tambah').modal('show');
			});
