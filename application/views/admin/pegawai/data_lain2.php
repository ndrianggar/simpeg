						...
						<div class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12">
									...
									<span  id="nama_s" ></span>
									<!-- <input id="nama_s" class="form-control"> -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12 has-feedback">
									...
									<span  id="tanggal_s" ></span>
<!-- 									<input id="tanggal_s" name="" class="form-control has-feedback-right tanggal" placeholder="Tanggal Surat (dd-mm-yyyy)" required="required">
									<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
 -->								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12">
									...
									<span  id="tempat_s" ></span>
									<!-- <input id="tempat_s" class="form-control"> -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12">
									...
									<span  id="keterangan_s" ></span>
									<!-- <input id="keterangan_s" class="form-control"> -->
								</div>
							</div>
							<div class="form-group">
								<label class="label-control col-md-4 col-sm-12 col-xs-12">File (pdf)</label>
								<div class="col-md-8 col-sm-12 col-xs-12">
									<input class="form-control" type="file" name="file_suratlain" id="file_suratlain" accept="application/pdf">
