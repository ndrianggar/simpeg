						...
						<div class="x_panel">
							<div class="x_title">
								<h2>
									...
									<a href="<?=base_url()?>meninggal">
										Data Pegawai Meninggal
									</a>
								</h2>
						...
						<div class="modal fade" id="modal-tambah">
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									<form name="form-tambah" id="form-tambah" method="POST" action="<?=base_url()?>meninggal/tambah">
														...
														<div class="col-md-12 col-sm-12 col-xs-12">
															<div class="col-md-6 col-sm-12 col-xs-12">
																<div class="form-horizontal">
																	<div class="form-group" id="nip_view" style="display: none;">
																		<label class="control-label col-md-4 col-sm-4 col-xs-12">NIP Pegawai</label>
																		<div class="col-md-8 col-sm-8 col-xs-12">
																			<input id="nip_edit" name="nip_edit" class="form-control">
																		</div>
																	</div>
																	<div class="form-group" id="nip_cari">
																		<label class="control-label col-md-4 col-sm-4 col-xs-12">NIP Pegawai</label>
																		<div class="col-md-8 col-sm-8 col-xs-12">
															...
															<div class="col-md-6 col-sm-12 col-xs-12">
																<div class="form-horizontal">
																	<div class="form-group ">
																		<label class="control-label col-md-4 col-sm-4 col-xs-12">Tanggal Meninggal</label>
																	...
																	<div class="form-group ">
																		<label class="control-label col-md-4 col-sm-4 col-xs-12">Akte Meninggal</label>
																		<div class="col-md-8 col-sm-8 col-xs-12">
																			<input id="akte_meninggal" name="akte_meninggal" class="form-control" placeholder="Akte Meninggal">
																		</div>
																	</div>
																	<div class="form-group ">
																		<label class="control-label col-md-4 col-sm-4 col-xs-12">File Meninggal</label>
																		<div class="col-md-8 col-sm-8 col-xs-12">
																			<input id="file_meninggal" name="file_meninggal" class="form-control" type="File" accept="application/pdf">
																		</div>
																	</div>
																	<div class="form-group ">
	...
	<script>
		$(document).ready(function(){
			...
			var tabel = $('#tabel-data').DataTable({
				...
				"sAjaxSource": 	'<?php echo base_url(); ?>meninggal/data/',
				"aoColumns":	[
									{ "mData"	: "no"},
									{ "mData"	: "foto"},
									{ "mData"	: "nama"},
			...
			$('#btn-tambah').click(function() {
				$('#form-tambah').attr('action','<?=base_url()?>meninggal/tambah');
				$('.modal-title').html('Tambah Data');
				$('#form-tambah')[0].reset();
				$('#nip_cari').attr('style','Display:block;');
				$('#nip_view').attr('style','Display:none;');
			...
			$('#tabel-body').on('click', '#btn-edit', function(){
				...
				$('#nip_cari').attr('style','Display:none;');
				$('#nip_view').attr('style','Display:block;');
				$('#nip_edit').val($(this).data('kode'));
				...
				$('#tanggal_meninggal').val($(this).data('tgl'));
				var tanggal_meninggal = $(this).data('tgl');
				$('#tanggal_meninggal').datepicker('update', tanggal_meninggal);
				$('#akte_meninggal').val($(this).data('akta'));
				$('#modal-tambah').modal('show');
			});
			...
			$('#nip').on('change',function(){
				$.ajax({
					...
					method: 	'post',
					dataType: 	'json',
					url: 		'<?=base_url()?>'+'meninggal/data_meninggal/' + $('#nip').val() ,
					async: 		true,
					success: 	function(response){
