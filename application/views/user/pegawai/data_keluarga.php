											...
											<div class="form-horizontal">
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														<select id="hubungan" name="hubungan" class="form-control selectpicker" required="required" title="-- Pilih Hubungan Keluarga --">
															<?php 
												...
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														<select id="jenis_dokumen" name="jenis_dokumen" class="form-control selectpicker" required="required" title="-- Pilih Jenis Dokumen --">
										...
										<div class="col-md-6 col-sm-12 col-xs-12">
											<div class="form-horizontal">
												...
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														<select id="status_perkawinan" name="status_perkawinan" class="form-control selectpicker" required="required" title="-- Pilih Status Pernikahan --">
												...
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														<select id="status_hidup" name="status_hidup" class="form-control selectpicker" required="required" title="-- Pilih Status Hidup --">
