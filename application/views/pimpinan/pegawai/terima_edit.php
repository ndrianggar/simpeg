										...
										<div class="col-md-6 col-sm-12 col-xs-12">
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													...
													<input id="nip_baru" name="nip_baru" class="form-control" placeholder="Kode Pegawai" required="required" value="<?=$row0->kd_pegawai?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">NIP Lama</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="nip_lama" name="nip_lama" class="form-control" placeholder="NIP Lama" value="<?=$row0->nip_lama?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Nama Pagawai *</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="nama_pegawai" name="nama_pegawai" class="form-control" placeholder="Nama Pegawai" required="required" value="<?=$row0->nm_pegawai?>" disabled>
												</div>
											</div> 
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Gelar Depan</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="gelar_depan" name="gelar_depan" class="form-control" placeholder="Gelar Depan" value="<?=$row0->gelar_depan?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Gelar Belakang</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="gelar_belakang" name="gelar_belakang" class="form-control" placeholder="Gelar Belakang" value="<?=$row0->gelar_belakang?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tempat Lahir *</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="tempat_lahir" name="tempat_lahir" class="form-control" placeholder="Tempat Lahir" required="required" value="<?=$row0->tempat_lahir?>" disabled>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tanggal_lahir" name="tanggal_lahir" class="form-control has-feedback-right tanggal" placeholder="Tanggal Lahir (dd-mm-yyyy)" required="required" value="<?=date('d-m-Y',strtotime($row0->tanggal_lahir))?>" disabled>
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="golongan_darah" name="golongan_darah" class="form-control" placeholder="Golongan Darah" value="<?=$row0->golongan_darah?>" disabled>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="email" name="email" class="form-control" placeholder="Email" required="required" value="<?=$row0->email_pegawai?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">EKTP *</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="ektp" name="ektp" class="form-control" placeholder="EKTP" required="required" value="<?=$row0->ektp_pegawai?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">NPWP</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="npwp" name="npwp" class="form-control" placeholder="NPWP" value="<?=$row0->npwp_pegawai?>" disabled>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<textarea id="jalan" name="jalan" class="form-control" rows="2" placeholder="Jalan/Desa" required="required" disabled><?=$row0->alamat_jalan?></textarea>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Handphone 1</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="no_hp1" name="no_hp1" class="form-control" placeholder="Handphone 1" value="<?=$row0->hp1_pegawai?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Handphone 2</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="no_hp2" name="no_hp2" class="form-control" placeholder="Handphone 2" value="<?=$row0->hp2_pegawai?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Telepon</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="telepon" name="telepon" class="form-control" placeholder="Telepon" value="<?=$row0->telepon_pegawai?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tinggi Badan (Cm)</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="tinggi" name="tinggi" class="form-control" type="number" style="text-align: right;" value="<?=$row0->tinggi_badan?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Berat Badan (Kg)</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="berat" name="berat" class="form-control" type="number" style="text-align: right;" value="<?=$row0->berat_badan?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Rambut</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="rambut" name="rambut" class="form-control" placeholder="Rambut" value="<?=$row0->rambut?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Bentuk Muka</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="muka" name="muka" class="form-control" placeholder="Bentuk Muka" value="<?=$row0->bentuk_muka?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Warna Kulit</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="kulit" name="kulit" class="form-control" placeholder="Warna Kulit" value="<?=$row0->warna_kulit?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Ciri Khas</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<textarea id="ciri" name="ciri" class="form-control" rows="2" disabled placeholder="Ciri Muka"><?=$row0->ciri_khas?></textarea>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Cacat Tubuh</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<textarea id="cacat" name="cacat" class="form-control" rows="2" placeholder="Cacat Tubuh" disabled><?=$row0->cacat_tubuh?></textarea>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Hobi</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="hobi" name="hobi" class="form-control" placeholder="Hobi" value="<?=$row0->hobi_pegawai?>" disabled>
												</div>
											</div>
										</div>
										<div class="col-md-6 col-sm-12 col-xs-12">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tmt_polines" name="tmt_polines" class="form-control has-feedback-right tanggal" placeholder="TMT Polines (dd-mm-yyyy)" required="required" value="<?=date('d-m-Y',strtotime($row0->tmt_polines))?>" disabled>
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true" disabled></span>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tmt_cpns" name="tmt_cpns" class="form-control has-feedback-right tanggal" placeholder="Tanggal CPNS (dd-mm-yyyy)" value="<?=date('d-m-Y',strtotime($row0->tmt_cpns))?>" disabled>
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true" disabled></span>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tmt_pns" name="tmt_pns" class="form-control has-feedback-right tanggal" placeholder="Tanggal PNS (dd-mm-yyyy)" value="<?=date('d-m-Y',strtotime($row0->tmt_pns))?>" disabled>
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true" disabled></span>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="no_sk" name="no_sk" class="form-control" placeholder="No. Karpeg" value="<?=$row0->no_sk?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Nomor S. BAKN</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="no_sbakn" name="no_sbakn" class="form-control" placeholder="Nomor S. BAKN" value="<?=$row0->no_sbakn?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tanggal S. BAKN</label>
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tgl_sbakn" name="tgl_sbakn" class="form-control has-feedback-right tanggal" placeholder="Tanggal S. BAKN (dd-mm-yyyy)" value="<?=date('d-m-Y',strtotime($row0->tgl_sbakn))?>" disabled>
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true" disabled></span>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="no_skmpk" name="no_skmpk" class="form-control" placeholder="Nomor SK. MPK" value="<?=$row0->no_skmpk?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tanggal SK. MPK</label>
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tgl_skmpk" name="tgl_skmpk" class="form-control has-feedback-right tanggal" placeholder="Tanggal SK. MPK (dd-mm-yyyy)" value="<?=date('d-m-Y',strtotime($row0->tgl_skmpk))?>" disabled>
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true" disabled></span>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="no_sttpl" name="no_sttpl" class="form-control" placeholder="Nomor STTPL" value="<?=$row0->no_sttpl?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tanggal STTPL</label>
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tgl_sttpl" name="tgl_sttpl" class="form-control has-feedback-right tanggal" placeholder="Tanggal STTPL (dd-mm-yyyy)" value="<?=date('d-m-Y',strtotime($row0->tgl_sttpl))?>" disabled>
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true" disabled></span>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="no_spmt" name="no_spmt" class="form-control" placeholder="Nomor SPMT" value="<?=$row0->no_spmt?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tanggal SPMT</label>
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tgl_spmt" name="tgl_spmt" class="form-control has-feedback-right tanggal" placeholder="Tanggal SPMT (dd-mm-yyyy)" value="<?=date('d-m-Y',strtotime($row0->tgl_spmt))?>" disabled>
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true" disabled></span>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="nomor_spmj" name="no_spmj" class="form-control" placeholder="Nomor SPMJ" value="<?=$row0->no_spmj?>" disabled>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tanggal SPMJ</label>
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tgl_spmj" name="tgl_spmj" class="form-control has-feedback-right tanggal" placeholder="Tanggal SPMJ (dd-mm-yyyy)" value="<?=date('d-m-Y',strtotime($row0->tgl_spmj))?>" disabled>
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true" disabled></span>
												</div>
											</div>
											<div class="form-group">
