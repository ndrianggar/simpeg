...
$content 		.= '</page>';
	...
	$content	.= 
				...
				<div style="margin-left:50px; margin-right:50px; margin-top:-12px; font-size:12px;">
					<table>
						<tr>
							<td>'.$lampiran.'</td>
						</tr>
				...
				<div style="float:right; margin-left:400px; margin-top:0px; font-size:12px;">
					<p>Semarang, '.date('d F Y',strtotime($tanggal_surat)).'</p>
					<p style="margin-top:-10px;">'.$nm_jabatan2.'</p>
					<br>
					<br>
					<p>'.$nama2.'</p>
