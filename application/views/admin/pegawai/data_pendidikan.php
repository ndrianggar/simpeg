						...
						<div class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8 col-xs-12">
									...
									<span  id="nama_p" ></span>
									<!-- <input id="nama_p" class="form-control"> -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8 col-xs-12">
									...
									<span  id="jurusan_p" ></span>
									<!-- <input id="jurusan_p" class="form-control"> -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
									...
									<span  id="awal_p" ></span>
									<!-- <input id="awal_p" name="" class="form-control has-feedback-right tanggal" placeholder="Tanggal Mulai (dd-mm-yyyy)" required="required"> -->
									<!-- <span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span> -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
									...
									<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
									<!-- <input id="akhir_p" name="" class="form-control has-feedback-right tanggal" placeholder="Tanggal Selesai (dd-mm-yyyy)" required="required"> -->
									<span  id="akhir_p" ></span>
									<!-- <span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span> -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8 col-xs-12">
									...
									<span  id="ijazah_p" ></span>
									<!-- <input id="ijazah_p" class="form-control"> -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8 col-xs-12">
									...
									<span  id="tempat_p" ></span>
									<!-- <input id="tempat_p" class="form-control"> -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8 col-xs-12">
									...
									<span  id="kepala_p" ></span>
									<!-- <input id="kepala_p" class="form-control"> -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-8 col-xs-12">
									...
									<a id="lihat_file_pendidikan" class="form-control" href="" target="_blank">Lihat File</a>
								</div>
							</div>
						</div>
					</div>
