	...
	<div class="container body">
		<div class="main_container">
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							...
							<div class="x_content">
								<form name="form-tambah" id="form-tambah" data-parsley-validate method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?=base_url()?>pegawai/tambah">
									<div class="row">
										<div class="col-md-6 col-sm-12 col-xs-12">
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													...
													<input id="nip_baru" name="nip_baru" class="form-control" placeholder="Kode Pegawai" required="required">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">NIP Lama</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="nip_lama" name="nip_lama" class="form-control" placeholder="NIP Lama">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Nama Pagawai *</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="nama_pegawai" name="nama_pegawai" class="form-control" placeholder="Nama Pegawai" required="required">
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<select id="jenis_kelamin" name="jenis_kelamin" class="form-control selectpicker" required="required" title="-- Pilih Jenis Kelamin --">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<select id="agama" name="agama" class="form-control selectpicker" required="required" title="-- Pilih Agama --">
														<?php
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													...
													<select id="golongan_darah" name="golongan_darah" class="form-control selectpicker" required="required" title="-- Pilih Golongan Darah --">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<select id="status_pernikahan" name="status_pernikahan" class="form-control selectpicker" required="required" title="-- Pilih Status Pernikahan --">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="email" name="email" class="form-control" placeholder="Email" required="required">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">EKTP *</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="ektp" name="ektp" class="form-control" placeholder="EKTP" required="required">
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<select id="propinsi" name="propinsi" class="form-control selectpicker" data-live-search="true" required="required" title="-- Pilih Propinsi --">
														<?php
											...
											<div class="form-group">
												...
												<div  id="kota2" class="col-md-6 col-sm-6 col-xs-12">
													<select id="kota" name="kota" class="form-control selectpicker" data-live-search="true" required="required" title="-- Pilih Kota --">
													</select>
												</div>
												<div class="col-md-2 col-sm-2 col-xs-12">
											...
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<select id="kecamatan" name="kecamatan" class="form-control selectpicker" data-live-search="true" required="required" title="-- Pilih Kecamatan --">
													</select>
												</div>
												<div class="col-md-2 col-sm-2 col-xs-12">
											...
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<select id="kelurahan" name="kelurahan" class="form-control selectpicker" data-live-search="true" required="required" title="-- Pilih Kelurahan --">
													</select>
												</div>
												<div class="col-md-2 col-sm-2 col-xs-12">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<textarea id="jalan" name="jalan" class="form-control" rows="2" placeholder="Jalan/Desa" required="required"></textarea>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="tinggi" name="tinggi" class="form-control" type="number" value="0" style="text-align: right;">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Berat Badan (Kg)</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="berat" name="berat" class="form-control" type="number" value="0" style="text-align: right;">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Rambut</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="rambut" name="rambut" class="form-control" placeholder="Rambut">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Bentuk Muka</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="muka" name="muka" class="form-control" placeholder="Bentuk Muka">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Warna Kulit</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="kulit" name="kulit" class="form-control" placeholder="Warna Kulit">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Ciri Khas</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<textarea id="ciri" name="ciri" class="form-control" rows="2" placeholder="Ciri Muka"></textarea>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Cacat Tubuh</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<textarea id="cacat" name="cacat" class="form-control" rows="2" placeholder="Cacat Tubuh"></textarea>
												</div>
											</div>
											<div class="form-group">
										...
										<div class="col-md-6 col-sm-12 col-xs-12">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<select id="prodi" name="prodi" class="form-control selectpicker" data-live-search="true" required="required" title="-- Pilih ProdiSubDiv --">
														<?php
														foreach ($prodi as $prodi) {
														 	echo '<option value="' . $prodi->id_prodi . '">' . $prodi->nm_prodi . '</option>';
														} 
														?>
													</select>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tmt_polines" name="tmt_polines" class="form-control has-feedback-right tanggal" placeholder="TMT Polines (dd-mm-yyyy)" required="required">
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tmt_cpns" name="tmt_cpns" class="form-control has-feedback-right tanggal" placeholder="Tanggal CPNS (dd-mm-yyyy)">
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tmt_pns" name="tmt_pns" class="form-control has-feedback-right tanggal" placeholder="Tanggal PNS (dd-mm-yyyy)">
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="no_sk" name="no_sk" class="form-control" placeholder="No. Karpeg">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Nomor S. BAKN</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="no_sbakn" name="no_sbakn" class="form-control" placeholder="Nomor S. BAKN">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tanggal S. BAKN</label>
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tgl_sbakn" name="tgl_sbakn" class="form-control has-feedback-right tanggal" placeholder="Tanggal S. BAKN (dd-mm-yyyy)">
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="no_skmpk" name="no_skmpk" class="form-control" placeholder="Nomor SK. MPK">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tanggal SK. MPK</label>
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tgl_skmpk" name="tgl_skmpk" class="form-control has-feedback-right tanggal" placeholder="Tanggal SK. MPK (dd-mm-yyyy)">
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="no_sttpl" name="no_sttpl" class="form-control" placeholder="Nomor STTPL">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tanggal STTPL</label>
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tgl_sttpl" name="tgl_sttpl" class="form-control has-feedback-right tanggal" placeholder="Tanggal STTPL (dd-mm-yyyy)">
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="no_spmt" name="no_spmt" class="form-control" placeholder="Nomor SPMT">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tanggal SPMT</label>
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tgl_spmt" name="tgl_spmt" class="form-control has-feedback-right tanggal" placeholder="Tanggal SPMT (dd-mm-yyyy)">
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="nomor_spmj" name="no_spmj" class="form-control" placeholder="Nomor SPMJ">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tanggal SPMJ</label>
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="tgl_spmj" name="tgl_spmj" class="form-control has-feedback-right tanggal" placeholder="Tanggal SPMJ (dd-mm-yyyy)">
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="foto" name="foto" type="file" class="form-control" accept="image/x-png,image/jpeg">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control"></label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<img id="PrevFoto" src="<?=base_url()?>assets/images/user.png" style="width: 300px;max-width: 300px;">
												</div>
											</div>
										</div>
										<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="modal fade" id="modal-tambah-kelurahan">
				<form id="form-tambah-kelurahan" method="POST" action="<?=base_url()?>alamat/tambah_kelurahan/">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal">×</button>
