...
'<style type="text/css">
	...
	$content	.= 
				...
				<div style="margin-left:50px; margin-top:20px; font-size:12px;">
					<table>
						...
						<tr>
							...
							<td>:</td>
							<td>'.$nm_pangkat.','.$gol.','.$ruang.'  '.date('d F Y',strtotime($tmt_pgrt_lama_pangkat)).'</td>
						</tr>
						<tr>
							<td>Jabatan TMT</td>
							<td>:</td>
							<td>'.$nm_jabatan.', '.date('d F Y',strtotime($tmt_jabatan_lama_pangkat)).'</td>
						</tr>
						<tr>
							<td>Unit Kerja</td>
							<td>:</td>
							<td>'.$unit_kerja_pangkat.'</td>
						</tr>
						<tr>
							<td>Jumlah Angka Kredit baru yagn diusulkan</td>
							<td>:</td>
							<td>'.$usulan_angka_kredit_pangkat.'</td>
						</tr>
						<tr>
							<td><b>Menjadi</b></td>
						</tr>
						<tr>
							<td>Jabatan TMT</td>
							<td>:</td>
							<td>'.$jabatan_baru_pangkat.', '.date('d F Y',strtotime($tmt_jabatan_baru_pangkat)).'</td>
						</tr>
						<tr>
							<td>Mata Kuliah</td>
							<td>:</td>
							<td>'.$mata_kuliah_pangkat.'</td>
						</tr>
						<tr>
							<td>Pangkat,golongan,ruang,TMT</td>
							<td>:</td>
							<td>'.$pgrt_baru_pangkat.', '.date('d F Y',strtotime($tmt_pgrt_baru_pangkat)).'</td>
						</tr>
				...
				<div style="margin-left:50px; margin-right:50px; margin-top:20px; font-size:12px;">
					<p style="margin-top:-8px;">'.$salam_persetujuan_pangkat.'</p>
				</div>

				<div style="margin-left:50px; margin-right:50px; margin-top:0px; font-size:12px;">
					<table>
						<tr>
							<td>'.$persetujuan_pangkat.'</td>
						</tr>
					</table>
				</div>
				<div style="margin-left:50px; margin-right:50px; margin-top:20px; font-size:12px;">
					<p style="margin-top:-8px;">'.$salam_pertimbangan_pangkat.'</p>
				</div>

				<div style="margin-left:50px; margin-right:50px; margin-top:0px; font-size:12px;">
					<table>
						<tr>
							<td>'.$pertimbangan_pangkat.'</td>
						</tr>
					</table>
				</div>
				...
				<div style="float:right; margin-left:400px; margin-top:0px; font-size:12px;">
					...
					<br>
					<p>'.$nama2.'</p>
					<p style="margin-top:-10px;">NIP. '.$nip2.' </p>
				</div>
				<div style="margin-left:50px; margin-top:-10px; font-size:12px;">
					<p>Tembusan :</p>
					<p style="margin-top:-10px;">'.$tembusan_pangkat.'</p>
				</div>
