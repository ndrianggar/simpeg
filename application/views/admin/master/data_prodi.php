											...
											<div class="form-horizontal">
												<div class="form-group">
													...
													<div class="col-md-8 col-sm-8 col-xs-12">
														<select id="tambah-jurusan" name="tambah-jurusan" class="form-control selectpicker" data-live-search="true" title="-- Pilih JurBagSatPusNit --">
															<?php
												...
												<div class="form-group">
													...
													<div class="col-md-8 col-sm-8 col-xs-12">
														<select id="tambah-jenjang" name="tambah-jenjang"  class="form-control selectpicker" data-live-search="true" title="-- Pilih Jenjang Pendidikan --">
															<?php
	...
	<script>
		$(document).ready(function(){
			...
			$('#btn-tambah').click(function(){
				$('#form-tambah')[0].reset();
				$('#tambah-jurusan').change();
				$('#tambah-jenjang').change();
			...
			$('#tabel-body').on('click', '#btn-ubah', function(){
				...
				$('#tambah-jurusan').val($(this).data('jurusan')).change();
				$('#tambah-jenjang').val($(this).data('jenjang')).change();
				$('#modal-tambah').modal('show');
			});
