										...
										<div class="modal-body">
											<div class="form-horizontal">
												<div class="form-group">
													<label class="col-md-4 col-sm-4 col-xs-12 control-label">Nama Agama</label>
													<div class="col-md-8 col-sm-8 col-xs-12">
														<input id="tambah-kode" name="tambah-kode" type="hidden">
														<input id="tambah-nama" name="tambah-nama" class="form-control" placeholder="Nama Agama" required="required">
													</div>
												</div>
											</div>
										</div>
	...
	<script>
		$(document).ready(function(){
			var tabel = $('#tabel-data').dataTable({
				...
				"sAjaxSource": 	'<?php echo base_url(); ?>agama/data',
				"aoColumns":	[
									{ "mData"	: "no"},
									{ "mData"	: "nama"}
								],
			...
			$('#btn-tambah').click(function(){
				$('#form-tambah').attr('action','<?=base_url()?>agama/tambah');
