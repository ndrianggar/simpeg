						...
						<div class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12">
									...
									<span  id="nama_o" ></span>
									<!-- <input id="nama_o" class="form-control"> -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12">
									...
									<span  id="jabatan_o" ></span>
									<!-- <input id="jabatan_o" class="form-control"> -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12 has-feedback">
									<input id="awal_organisasi" name="awal_organisasi" class="form-control has-feedback-right tanggal" placeholder="tanggal awal (dd-mm-yyyy)" required="required">
									<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
									<span  id="awal_o" ></span>
<!-- 									<input id="awal_o" name="" class="form-control has-feedback-right tanggal" placeholder="tanggal awal (dd-mm-yyyy)" required="required">
									<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
 -->								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12 has-feedback">
									<input id="akhir_organisasi" name="akhir_organisasi" class="form-control has-feedback-right tanggal" placeholder="tanggal akhir (dd-mm-yyyy)" required="required">
									<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
									<span  id="akhir_o" ></span>
<!-- 									<input id="akhir_o" name="" class="form-control has-feedback-right tanggal" placeholder="tanggal awal (dd-mm-yyyy)" required="required">
									<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
 -->								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12">
									...
									<span  id="tempat_o" ></span>
									<!-- <input id="tempat_o" class="form-control"> -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12">
									...
									<span  id="ketua_o" ></span>
									<!-- <input id="ketua_o" class="form-control"> -->
								</div>
							</div>
							<div class="form-group">
								<label class="label-control col-md-4 col-sm-12 col-xs-12">File (pdf)</label>
								<div class="col-md-8 col-sm-12 col-xs-12">
									<input class="form-control" type="file" id="file_organisasi" name="file_organisasi" accept="application/pdf">
									<a id="lihat_file_organisasi" class="form-control" href="" target="_blank">Lihat File</a>
								</div>
							</div>
						</div>
					</div>
