						...
						<div class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12">
									...
									<span  id="negara_j" ></span>
									<!-- <input id="negara_j" class="form-control"> -->
							...
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12">
									...
									<span  id="tujuan_j" ></span>
									<!-- <input id="tujuan_j" class="form-control"> -->
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12 has-feedback">
									<input id="awal_kunjungan" name="awal_kunjungan" class="form-control has-feedback-right tanggal"  placeholder="tanggal awal (dd-mm-yyyy)" required="required">
									<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
									<span  id="awal_j" ></span>
<!-- 									<input id="awal_j" name="" class="form-control has-feedback-right tanggal"  placeholder="tanggal awal (dd-mm-yyyy)" required="required">
									<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
 -->								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12 has-feedback">
									<input id="akhir_kunjungan" name="akhir_kunjungan" class="form-control has-feedback-right tanggal"  placeholder="tanggal akhir (dd-mm-yyyy)" required="required">
									<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
									<span  id="akhir_j" ></span>
<!-- 									<input id="akhir_j" name="" class="form-control has-feedback-right tanggal"  placeholder="tanggal awal (dd-mm-yyyy)" required="required">
									<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
 -->								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-12 col-xs-12">
									...
									<span  id="pembiayaan_j" ></span>
									<!-- <input id="pembiayaan_j" class="form-control"> -->
								</div>
							</div>
							<div class="form-group">
								<label class="label-control col-md-4 col-sm-12 col-xs-12">File (pdf)</label>
								<div class="col-md-8 col-sm-12 col-xs-12">
									<input class="form-control" type="file" id="file_kunjungan" name="file_kunjungan" accept="application/pdf">
									<a id="lihat_file_kunjungan" class="form-control" href="" target="_blank">Lihat File</a>
								</div>
							</div>
						</div>
					</div>
