				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							...
							<div class="x_content">
								<form name="form-tambah"  id="form-tambah" data-parsley-validate method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?=base_url()?>gaji/edit">
									<?php 
									$hal = '';
									$tujuan = '';
									$pembukaan = '';
										...
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="kd_naik_gaji" name="kd_naik_gaji" class="form-control" value="<?=$row->kd_naik_gaji?>"  type="hidden">
													<input id="nomor_surat" name="nomor_surat" class="form-control" placeholder="Nomor Surat" value="<?=$row->nomor_surat?>" >
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tanggal Surat</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="tanggal_surat" name="tanggal_surat" class="form-control has-feedback-right tanggal" placeholder="Tanggal Surat (dd-mm-yyyy)" value="<?=$row->tanggal_gaji?>">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="id_pegawai" name="id_pegawai" class="form-control" value="<?=$row->id_pegawai?>" type="hidden">
													<input id="nama_pegawai" name="nama_pegawai" class="form-control has-feedback-right" placeholder="Nama Pegawai" value="<?=$row->nm_pegawai?>">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="nip_pangkat" name="nip_pangkat" value="<?=$row->nip_baru?>" class="form-control" placeholder="NIP Pegawai">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-4 col-xs-12">
													<select id="pangkat_pegawai" name="pangkat_pegawai" class="form-control selectpicker" data-live-search="true">
														<?php foreach ($pangkat as $row1) { 
															if (($row->pangkat_pegawai)==($row1->kd_pangkat)) { ?>
												...
												<div class="col-md-8 col-sm-4 col-xs-12">
													<select id="jabatan_pegawai" name="jabatan_pegawai" class="form-control selectpicker" data-live-search="true">
														<?php foreach ($jabatan as $row2) { 
															if (($row->jabatan_pegawai)==($row2->kd_jabatan)) { ?>
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="kantor" name="kantor" class="form-control" placeholder="Kantor/Tempat" value="<?=$row->kantor?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Gaji Pokok</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="gaji_pokok" name="gaji_pokok" class="form-control" placeholder="Gaji Pokok" value="<?=$row->gaji_pokok?>">
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="oleh_pejabat" name="oleh_pejabat" class="form-control" placeholder="Oleh Pejabat" value="<?=$row->pejabat?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tanggal SKP</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="tanggal_skp" name="tanggal_skp" class="form-control has-feedback-right tanggal" placeholder="Tanggal SKP (dd-mm-yyyy)" value="<?=$row->tanggal_pejabat?>">
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="nomor_pejabat" name="nomor_pejabat" class="form-control" placeholder="Nomor SKP" value="<?=$row->nomor_pejabat?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tanggal Berlaku Gaji</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="tanggal_berlaku" name="tanggal_berlaku" class="form-control has-feedback-right tanggal" placeholder="Tanggal SKP (dd-mm-yyyy)" value="<?=$row->tanggal_berlaku?>">
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="masa_kerja" name="masa_kerja" class="form-control" placeholder="Masa Kerja Pada Tanggal tsb" value="<?=$row->masa_kerja?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control"></label>
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="gaji_baru" name="gaji_baru" value="<?=$row->gaji_baru?>" class="form-control" placeholder="Gaji Pokok Baru">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tunjangan Jabatan</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="tunjangan_jabatan" name="tunjangan_jabatan" class="form-control" placeholder="Tunjangan Jabatan" value="<?=$row->tunjangan_jabatan?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Berdasarkan Masa Kerja</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="masa_kerja_baru" name="masa_kerja_baru" class="form-control" placeholder="Berdasarkan Masa Kerja" value="<?=$row->masa_kerja_baru?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Dalam Golongan</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="golongan" name="golongan" class="form-control" placeholder="Dalam Golongan" value="<?=$row->golongan?>">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Tanggal Mulai</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="tanggal_mulai" name="tanggal_mulai" class="form-control has-feedback-right tanggal" placeholder="Tanggal Mulai (dd-mm-yyyy)" value="<?=$row->mulai_tanggal?>">
													<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-8 col-sm-8 col-xs-12 has-feedback">
													<input id="penandatangan_pegawai" name="penandatangan_pegawai" class="form-control" type="hidden" value="<?=$row->penandatangan_pegawai?>">
													<input id="nama_penandatangan" name="nama_penandatangan" class="form-control has-feedback-right" placeholder="Nama Penandatangan" value="<?=$row->nama?>">
											...
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">NIP</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<input id="nip_penandatangan" name="nip_penandatangan" value="<?=$row->nip?>" class="form-control" placeholder="NIP Pegawai">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-4 col-sm-4 col-xs-12 label-control">Jabatan</label>
												<div class="col-md-8 col-sm-8 col-xs-12">
													<select id="penandatangan_jabatan" name="penandatangan_jabatan" class="form-control selectpicker" data-live-search="true">
														<?php foreach ($jabatan2 as $row3) { 
															if (($row->kd_jabatan)==($row3->kd_jabatan)) { ?>
	...
	<script>
		$(document).ready(function(){
			...
			$('#btn-simpan').click(function() {
				...
				$('#form-tambah').attr('action','<?=base_url()?>gaji/edit').submit();
