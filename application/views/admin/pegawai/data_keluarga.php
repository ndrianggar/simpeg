											...
											<div class="form-horizontal">
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="hubungan_kk" ></span>
														<!-- <input id="hubungan_kk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="nama_kk" ></span>
														<!-- <input id="nama_kk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="depan_kk" ></span>
														<!-- <input id="depan_kk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="belakang_kk" ></span>
														<!-- <input id="belakang_kk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="jenis_dkk" ></span>
														<!-- <input id="jenis_dkk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="nomor_dkk" ></span>
														<!-- <input id="nomor_dkk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="jenis_kkk" ></span>
														<!-- <input id="jenis_kkk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="agama_kk" ></span>
														<!-- <input id="agama_kk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="tempat_lkk" ></span>
														<!-- <input id="tempat_lkk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12 has-feedback">
														...
														<span  id="tanggal_lkk" ></span>
<!-- 														<input id="tanggal_lkk" name="" class="form-control has-feedback-right tanggal" placeholder="Tanggal Meninggal (dd-mm-yyyy)">
														<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
 -->													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="akte_lkk" ></span>
														<!-- <input id="akte_lkk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group nikah" style="display: none;">
													...
													<div class="col-md-7 col-sm-8 col-xs-12 has-feedback">
														...
														<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
														<span  id="tanggal_nkk" ></span>
<!-- 														<input id="tanggal_nkk" name="" class="form-control has-feedback-right tanggal" placeholder="Tanggal Meninggal (dd-mm-yyyy)">
														<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
 -->													</div>
												</div>
												<div class="form-group nikah" style="display: none;">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="akte_nkk" ></span>
														<!-- <input id="akte_nkk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group nikah" style="display: none;">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="status_ckk" ></span>
														<!-- <input id="status_ckk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group cerai" style="display: none;">
													...
													<div class="col-md-7 col-sm-8 col-xs-12 has-feedback">
														...
														<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
														<span  id="tanggal_ckk" ></span>
<!-- 														<input id="tanggal_ckk" name="" class="form-control has-feedback-right tanggal" placeholder="Tanggal Meninggal (dd-mm-yyyy)">
														<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
 -->													</div>
												</div>
												<div class="form-group cerai" style="display: none;">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="akte_ckk" ></span>
														<!-- <input id="akte_ckk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="alamat_kk" ></span>
														<!-- <input id="alamat_kk" class="form-control"> -->
													</div>
												</div>
											</div>
										</div>
											...
											<div class="form-horizontal">
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="handphone_kk" ></span>
														<!-- <input id="handphone_kk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="telepon_kk" ></span>
														<!-- <input id="telepon_kk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="email_kk" ></span>
														<!-- <input id="email_kk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="status_pkk" ></span>
														<!-- <input id="status_pkk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="pekerjaan_kk" ></span>
														<!-- <input id="pekerjaan_kk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="keterangan_kk" ></span>
														<!-- <input id="keterangan_kk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="status_hkk" ></span>
														<!-- <input id="status_hkk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group meninggal" style="display: none;">
													...
													<div class="col-md-7 col-sm-8 col-xs-12 has-feedback">
														...
														<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
														<span  id="tanggal_mkk" ></span>
<!-- 														<input id="tanggal_mkk" name="" class="form-control has-feedback-right tanggal" placeholder="Tanggal Meninggal (dd-mm-yyyy)">
														<span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
 -->													</div>
												</div>
												<div class="form-group meninggal" style="display: none;">
													...
													<div class="col-md-7 col-sm-8 col-xs-12">
														...
														<span  id="akte_mkk" ></span>
														<!-- <input id="akte_mkk" class="form-control"> -->
													</div>
												</div>
												<div class="form-group">
